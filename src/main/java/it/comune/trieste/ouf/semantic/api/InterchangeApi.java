...
public class InterchangeApi {
  ...
  @SemanticCapability("ouf.semantic.propose") @PostMapping(value="/imports",consumes={"text/turtle","application/ld+json","application/rdf+xml","application/n-triples"})
