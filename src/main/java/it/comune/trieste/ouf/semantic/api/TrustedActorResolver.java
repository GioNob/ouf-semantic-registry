...
public class TrustedActorResolver {
  ...
  public String authorizationDecisionRef(HttpServletRequest request){Object value=request.getAttribute("ouf.authorizationDecisionRef");if(!(value instanceof String ref)||ref.isBlank()){value=request.getAttribute("ouf.authorizationContextRef");}if(!(value instanceof String ref)||ref.isBlank())throw new Forbidden("SEM_AUTHORIZATION_CONTEXT_REQUIRED");return ref;}
