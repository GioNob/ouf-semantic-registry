...
public class DiscoveryApi {
  ...
  @PostMapping Map<String,Object> create(@RequestBody Request r,HttpServletRequest request){UUID id=service.request(r.requestedArtifactType(),r.intent(),r.preferredLanguages()==null?List.of():r.preferredLanguages(),actors.actor(request).subject());return Map.of("requestId",id,"state","PENDING");}
