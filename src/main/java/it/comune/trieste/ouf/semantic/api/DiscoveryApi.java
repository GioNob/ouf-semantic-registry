...
public class DiscoveryApi {
  ...
  @SemanticCapability("ouf.semantic.discovery") @GetMapping("/{id}/candidates") List<Map<String,Object>> candidates(@PathVariable UUID id){return service.candidates(id);}
