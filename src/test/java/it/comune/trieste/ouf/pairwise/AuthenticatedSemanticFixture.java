...
public class AuthenticatedSemanticFixture {
  ...
  public static final class FixtureIdentityFilter implements Filter {
    ...
    @Override public void doFilter(ServletRequest input,ServletResponse output,FilterChain chain) throws IOException,ServletException {
      ...
      request.setAttribute(TrustedActorResolver.ACTOR_TYPE,"SERVICE");
      request.setAttribute(TrustedActorResolver.CAPABILITIES,Set.of("ouf.semantic.read","ouf.semantic.discovery","ouf.semantic.propose"));
      request.setAttribute(TrustedActorResolver.DECISION_REF,"fixture-policy:1:semantic-discovery");
      chain.doFilter(new HttpServletRequestWrapper(request) {
        @Override public Principal getUserPrincipal(){return ()->"pairwise-discovery-service";}
